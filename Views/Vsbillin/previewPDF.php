...
<div id="page_pdf">
  ...
  <?php
                switch($factura_head['DOCTIP'])
                {
                  case 'FA':
  ?>
                    <div class="col-md-4">Factura No.: <strong><?= $termino.'-'.str_pad($factura_head['DOCNUM'], 9, "0", STR_PAD_LEFT) ?></strong></div>
  <?php
                    break;
                  case 'RC':
  ?>
                    <div class="col-md-4">Recibo No.: <strong><?= $termino.'-'.str_pad($factura_head['DOCNUM'], 9, "0", STR_PAD_LEFT) ?></strong></div>
  <?php
                    break;
                  case 'NC':
  ?>
                    <div class="col-md-4">Nota de Crédito No.: <strong><?= $termino.'-'.str_pad($factura_head['DOCNUM'], 9, "0", STR_PAD_LEFT) ?></strong></div>
  <?php
                    break;
                }
  ?>
  ...
  <div class="pt-4">
    <div class="row">
      ...
      <div class="col-md-9 mt-1">
        ...
        <!-- Formato de barcode en HTML no se recomienda para la impresión ------->
