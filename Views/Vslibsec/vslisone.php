...
<main>
  <div class="app-title">
      ...
      <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?= base_url(); ?>Vslibsec">Retornar</a></li>
      </ul>
  </div>
  ...
  ?>
              <section id="vslisone" class="invoice">
  <?php 
              for($std = 0; $std < count($estudiante); $std++)
              {
                $std_no = $estudiante[$std]['STD_NO'];
  ?>
                <div class="row mb-4">
                ...
                <div class="row invoice-info">
                  ...
                  <div class="col-9">
                      <?= $estudiante[$std]['LAS_NM'].' '.$estudiante[$std]['FIR_NM']; ?>
                  </div>
  ...
  ?>
                    ...
                    <tbody>
  <?php 
                        for($ii = $std; $ii < count($estudiante); $ii++)
                        {
                          if($std_no == $estudiante[$ii]['STD_NO'])
                          {
                          }else{
                              break;
                          }
  ?>
                          <tr>
                          <td class="text-left"><?= $estudiante[$ii]['MAT_NM'] ?></td>  
  <?php 
                          if(true)
                          {
                            if($mparci)
                            {  
  ?>
                              <td class="text-center"><?= $estudiante[$ii][$Pun001] ?></td>
                              <td class="text-center"><?= $estudiante[$ii][$Pun002] ?></td>
                              <td class="text-center"><?= $estudiante[$ii][$Pun003] ?></td>
                              <td class="text-center"><?= $estudiante[$ii][$Pun004] ?></td>
                              <td class="text-center"><?= $estudiante[$ii][$Pun005] ?></td>
                              <td class="text-center"><?= $estudiante[$ii][$Pun008] ?></td>
  <?php 
                            }else if($mfinal){
  ?>
                              <td class="text-center"><?= $estudiante[$ii][$Pun001] ?></td>
                              ...
                              <td class="text-center"><?= $estudiante[$ii][$Pun004] ?></td>
                              <td class="text-center"><?= $estudiante[$ii][$Pun005] ?></td>
                              <td class="text-center"><?= $estudiante[$ii][$Pun006] ?></td>
  <?php
                            }else{
  ?>
                              <td class="text-center"><?= $estudiante[$ii][$Pun001] ?></td>
  ...
  ?>      
          <div class="row d-print-none mt-2">
                <div class="col-12 text-right">
                    <a class="btn btn-primary" onclick="printDiv('vslisone')"><i class="fa fa-print"></i> Imprimir</a>
                </div>
          </div>
          </section>
  <?php
