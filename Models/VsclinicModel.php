 <?php
	...
	class VsclinicModel extends Mysql
	{
		public $intSec_id;
		public $intStd_no;
		public $intCas_no;
		...
		public function selectVsclinic()
		{
			$sql = "SELECT	a.SEC_ID,
				           	a.FECREG,
			               	v.LAS_NM,
		...
		public function oneVsclinic(int $idSec)
		{
		...
		public function insertVsclinic(int $std_no, int $cas_no, string $fecreg, string $fecnex, string $weighs, string $heighs, string $presur, string $temper, string $proble, string $explor, string $tratam, string $remark, string $hiscod)
		{
   			$return = "";
		...
		public function updateVsclinic(int $sec_id, int $std_no, int $cas_no, string $fecreg, string $fecnex, string $weighs, string $heighs, string $presur, string $temper, string $proble, string $explor, string $tratam, string $remark, string $hiscod)
		{
   			$return = "";
